        ...
        for (i = 0; i < 8; i++){
            for (j = 0; j < 8; j++){
                if(Tabuleiro[i][j]==cont){
                    posiinicial[1]=i+1;
                    if(j==0) posiinicial[0]='a';if(j==1) posiinicial[0]='b';if(j==2) posiinicial[0]='c';if(j==3) posiinicial[0]='d';if(j==4) posiinicial[0]='e';if(j==5) posiinicial[0]='f';if(j==6) posiinicial[0]='g';if(j==7) posiinicial[0]='h';
                    console.log(posiinicial);
                    cont++;
                }
            }
